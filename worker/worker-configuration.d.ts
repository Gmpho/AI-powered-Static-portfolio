/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2129e3ec5f120819c61e813869a5f09d)
// Runtime types generated with workerd@1.20250823.0 2025-09-15 
declare namespace Cloudflare {
	interface Env {
		ACCOUNT_ID: string;
		GEMINI_API_KEY: string;
		ALLOWED_ORIGINS: string;
		RESUME_SIGNER_SECRET: string;
